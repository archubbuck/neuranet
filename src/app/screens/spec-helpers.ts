...
export const FIXTURE_NODES: readonly Node[] = [
	{ id: 'n1', label: 'Climate', desc: 'climate change overview', cluster: 'c1', r: 14, importance: 8, depth: 0, isCentral: true, degree: 2 },
	{ id: 'n2', label: 'Renewable', desc: 'solar and wind', cluster: 'c1', r: 12, importance: 6, depth: 1, isCentral: false, degree: 1 },
	{ id: 'n3', label: 'Genomics', desc: 'gene sequencing', cluster: 'c2', r: 14, importance: 8, depth: 0, isCentral: true, degree: 1 },
];

export const FIXTURE_EDGES: readonly Edge[] = [
	{ source: 'n1', target: 'n2', kind: 'same-doc' },
];

export const FIXTURE_DOCS: readonly Doc[] = [
	{ id: 1, title: 'Climate Brief', text: 'Climate change requires renewable energy.', status: 'derived', derivedNodeSlugs: ['n1', 'n2'] },
];
