...
/**
 * Stub privacy policy page — placeholder for the public market site.
  ...
  template: `
    <div class="flex flex-col min-h-screen">
      ...
      <main class="flex-1 px-8 py-16 max-w-[48rem] mx-auto">
        <h1 class="text-[2rem] mb-4">Privacy Policy</h1>
        <p class="text-fg-2 leading-relaxed">
          Coming soon — our privacy policy will be published here.
        </p>
      </main>
