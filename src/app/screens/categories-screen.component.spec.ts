...
describe('CategoriesScreenComponent', () => {
	...
	it('selects rows via checkboxes', () => {
		...
		const checkboxes = (fixture.nativeElement as HTMLElement).querySelectorAll('app-checkbox button');
	...
	it('cycles sort asc → desc → none on repeated clicks', () => {
		...
		fixture.detectChanges();
		const cmp = fixture.componentInstance as any;
		const btn = (fixture.nativeElement as HTMLElement).querySelector('.th-sort') as HTMLButtonElement;
